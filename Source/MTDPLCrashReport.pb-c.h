...
typedef enum _Plcrash__CrashReport__Processor__TypeEncoding {
   ...
   */
  MTDPLCRASH__CRASH_REPORT__PROCESSOR__TYPE_ENCODING__TYPE_ENCODING_UNKNOWN = 0,
  /*
   * Apple Mach-defined processor types. 
   */
  MTDPLCRASH__CRASH_REPORT__PROCESSOR__TYPE_ENCODING__TYPE_ENCODING_MACH = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MTDPLCRASH__CRASH_REPORT__PROCESSOR__TYPE_ENCODING)
...
typedef enum _Plcrash__CrashReport__SystemInfo__OperatingSystem {
   ...
   * Mac OS X 
   */
  MTDPLCRASH__CRASH_REPORT__SYSTEM_INFO__OPERATING_SYSTEM__MAC_OS_X = 0,
  /*
   * iPhone OS 
   */
  MTDPLCRASH__CRASH_REPORT__SYSTEM_INFO__OPERATING_SYSTEM__IPHONE_OS = 1,
  /*
   * iPhone Simulator (Mac OS X w/ simulator runtime environment) 
   */
  MTDPLCRASH__CRASH_REPORT__SYSTEM_INFO__OPERATING_SYSTEM__IPHONE_SIMULATOR = 2,
  /*
   * Apple tvOS 
   */
  MTDPLCRASH__CRASH_REPORT__SYSTEM_INFO__OPERATING_SYSTEM__APPLE_TVOS = 4,
  /*
   * Unknown operating system. 
   */
  MTDPLCRASH__CRASH_REPORT__SYSTEM_INFO__OPERATING_SYSTEM__OS_UNKNOWN = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MTDPLCRASH__CRASH_REPORT__SYSTEM_INFO__OPERATING_SYSTEM)
...
typedef enum _Plcrash__Architecture {
   ...
   * x86 
   */
  MTDPLCRASH__ARCHITECTURE__X86_32 = 0,
  /*
   * x86-64 
   */
  MTDPLCRASH__ARCHITECTURE__X86_64 = 1,
  /*
   * ARMv6 
   */
  MTDPLCRASH__ARCHITECTURE__ARMV6 = 2,
  /*
   * PPC 
   */
  MTDPLCRASH__ARCHITECTURE__PPC = 3,
  /*
   ** PPC64 
   */
  MTDPLCRASH__ARCHITECTURE__PPC64 = 4,
  /*
   * ARMv7 
   */
  MTDPLCRASH__ARCHITECTURE__ARMV7 = 5,
  /*
   * Unknown processor type. 
   */
  MTDPLCRASH__ARCHITECTURE__ARCHITECTURE_UNKNOWN = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MTDPLCRASH__ARCHITECTURE)
...
#define MTDPLCRASH__CRASH_REPORT__PROCESSOR__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&plcrash__crash_report__processor__descriptor) \
    , 0, MTDPLCRASH__CRASH_REPORT__PROCESSOR__TYPE_ENCODING__TYPE_ENCODING_UNKNOWN, 0, 0 }
...
#define MTDPLCRASH__CRASH_REPORT__SYSTEM_INFO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&plcrash__crash_report__system_info__descriptor) \
    , 0, MTDPLCRASH__CRASH_REPORT__SYSTEM_INFO__OPERATING_SYSTEM__OS_UNKNOWN, NULL, MTDPLCRASH__ARCHITECTURE__ARCHITECTURE_UNKNOWN, 0, NULL }
...
#define MTDPLCRASH__CRASH_REPORT__APPLICATION_INFO__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__SYMBOL__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__THREAD__STACK_FRAME__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__THREAD__REGISTER_VALUE__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__THREAD__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__BINARY_IMAGE__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__EXCEPTION__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__SIGNAL__MACH_EXCEPTION__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__SIGNAL__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__PROCESS_INFO__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__MACHINE_INFO__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__REPORT_INFO__INIT \
...
#define MTDPLCRASH__CRASH_REPORT__INIT \
